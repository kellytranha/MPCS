...
class Order(dict):
    ...
    def __repr__(self) -> str:
        return f'Order:[Client: {self.client}, Schedule: {self.schedule}, Item:{self.item}, C ancel:{self.cancl}]'
...
class App:
    ...
    def make_re(self,client:str, s:Schedule, item):
    ...
    def clntrp(self, client, start, end)-> list:
